...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="lteBuildingController.do?doAdd" tiptype="1" >
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="buildingProperty" name="buildingProperty" type="text" class="form-control"  ignore="ignore" />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					 ...
					 <div class="row show-grid">
			          ...
			          <div class="col-xs-3">
						  	 	<textarea id="note" class="form-control" rows="6" style="width: 600px" name="note"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
