...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="lteBuildingList" checkbox="true" pagination="true" fitColumns="true" title="lte_building"
            ...
            <t:dgToolBar title="word模板下载" icon="icon-add" url="lteBuildingController.do?exportWord" funname="ExportWord"></t:dgToolBar>
            <%--<t:dgToolBar title="" icon="icon-putout" url="lteBuildingController.do?goUpdate"></t:dgToolBar>--%>
        </t:datagrid>
    </div>
</div>
<script src="webpage/com/jeecg/building/lteBuildingList.js"></script>
<script type="text/javascript">
    ...
    //模板下载
    function ExportWord() {
        window.location.href = "lteBuildingController.do?exportWord&id=2";
    }
