...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ltePgmDataController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="pgmConfigId" name="pgmConfigId" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="checked" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="taskId" name="taskId" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:600px;" class="inputxt" rows="6" id="pgmData" name="pgmData"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
